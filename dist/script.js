...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {// form: 0,
    // type: "tree",
  };
  var deadline = '2021-03-11';
...
var changeModalState = function changeModalState(state) {
  ...
  bindActionToElements('input', windowHeight, 'heigth');
...
var forms = function forms(state) {
  var allForms = document.querySelectorAll('form'),
      inputs = document.querySelectorAll('input'); // if ()
      ...
      item.addEventListener('click', function (e) {
        ...
        if (openModal.classList.contains('popup_calc_profile')) {
          if (!state.form || !state.width || !state.height) {
            ...
            alert('Заполните все поля1');
            return;
          } else {// document.querySelector('.popup_calc_button').disabled = false;
          }
        }
        ...
        if (openModal.classList.contains('popup_calc_end')) {
          if (!state.type || !state.profile) {
            ...
            alert('Заполните все поля2');
          } else {
            document.querySelector('.popup_calc_profile_button').disabled = false;
          }
        } // Если идёт клик на кнопку popup_calc_button и поля Тип окна, Ширина и Высота не заполнены, то
        // сделать сообщение "Заполните все поля", кнопка не нажимается
        // Если идет клик на кнопку popup_calc_profile_button и поля Тип и Профиль не заполнены, то 
        // сделать сообщение "Заполните все поля", кнопка не нажимается
        // Иначе продолжить переключение кнопки
        // Да, можно воспользоваться атрибутом disabled, а можно при клике на кнопку (и не соблюдении условий) - показывать пользователю сообщение, что необходимо заполнить то и то.
        // По поводу реализации - тут много вариантов. Но все они будут отталкиваться от заполненности input'ов. Это справедливо и к чекбоксам (атрибут checked) и к type="text" (атрибут value) и другим.
